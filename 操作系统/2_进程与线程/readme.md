...
![读者写者问题](./img/读者写者问题.jpg "读者写者问题")

## 10. 哲学家进餐问题

思路：
- 最多n-1个哲学家同时吃饭(n为哲学家的个数)。这样可以保证至少有一个人能顺利开吃，那么就不会死锁。
- 编号单数的哲学家先拿左手筷子，偶数先拿右手筷子。优先竞争特定临界资源，不会死锁。
- 哲学家必须互斥的拿筷子，且拿满两支筷子后才会解锁拿筷子锁。这相当于先来的人先声明占有筷子。

![哲学家进餐问题](./img/哲学家进餐问题.png "哲学家进餐问题")

![哲学家进餐问题code](./img/哲学家进餐问题code.png "哲学家进餐问题code")

## 管程

![管程](./img/%E7%AE%A1%E7%A8%8B.jpg "管程")

## 死锁

![死锁](./img/死锁.jpg "死锁")

![预防死锁](./img/预防死锁.jpg "预防死锁")

![银行家算法](./img/%E9%93%B6%E8%A1%8C%E5%AE%B6%E7%AE%97%E6%B3%95.jpg "银行家算法")

![死锁检测与解除](./img/死锁检测与解除.jpg "死锁检测与解除")

死锁的必要条件：
1. 互斥：进程要求分配的资源是排他性的。
2. 占有并请求：进程占有自身本来拥有的资源并要求其他资源
3. 非剥夺：在进程使用完资源之前(或主动释放资源之前)，资源不能被强制夺走
4. 循环等待：存在一种进程资源的循环等待链

- 死锁预防：设立一些限制条件，破坏死锁的一些必要条件，让死锁无法发生。如资源有序分配算法。
- 死锁避免：在动态分配资源的过程中，用一些算法防止系统进入不安全状态，从而避免死锁。如银行家算法。
- 死锁检测和解除：在死锁产生前不采取措施，只检测当前系统有没有发生死锁，所有，则采取一些措施解除死锁。如资源剥夺法、撤销进程法、进程回退法。
